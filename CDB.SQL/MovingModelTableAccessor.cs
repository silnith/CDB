...
///   <item><term><see cref="MovingModel.Dataset"/></term><description><see cref="SQLCDB.DatasetParamName"/></description></item>
///   <item><term><see cref="MovingModel.ComponentSelector1"/></term><description><see cref="SQLCDB.ComponentSelector1ParamName"/></description></item>
///   <item><term><see cref="MovingModel.ComponentSelector2"/></term><description><see cref="SQLCDB.ComponentSelector2ParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Kind"/></term><description><see cref="SQLCDB.DISKindParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Domain"/></term><description><see cref="SQLCDB.DISDomainParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Country"/></term><description><see cref="SQLCDB.DISCountryParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Category"/></term><description><see cref="SQLCDB.DISCategoryParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Subcategory"/></term><description><see cref="SQLCDB.DISSubcategoryParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Specific"/></term><description><see cref="SQLCDB.DISSpecificParamName"/></description></item>
///   <item><term><see cref="MovingModel.MMDC"/> <see cref="DISEntity.Extra"/></term><description><see cref="SQLCDB.DISExtraParamName"/></description></item>
///   <item><term><see cref="MovingModel.FileType"/></term><description><see cref="SQLCDB.FileTypeParamName"/></description></item>
/// </list>
/// </remarks>
public class MovingModelTableAccessor : TableAccessor<MovingModel>
{
    public MovingModelTableAccessor(SQLCDB sqlCDB)
