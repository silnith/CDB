...
public class SQLiteCDB : SQLCDB
{
    ...
    public SQLiteCDB(DbDataSource dbDataSource, IOptions<SQLiteCDBSettings> options)
    ...
    /// <remarks>
    /// <para>
    /// SQLite does not know how to read a stream.  Therefore we need to
    ...
    public override void SetContentParameter(DbCommand dbCommand, Stream content)
    {
        ...
        dbCommand.Parameters[ContentParamName].Value = memoryStream.ToArray();
    }
